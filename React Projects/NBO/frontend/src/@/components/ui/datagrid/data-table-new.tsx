...
export const Datagrid = ({
        ...
        <PaginationContent className='w-full flex gap-3 items-center  justify-between'>
          <PaginationItem
            ...
            className={cn(
              ...
              "  !rounded-[8px] shadow-[rgba(10,13,18,0.05)]  cursor-pointer text-[14px] font-semibold text-gray-700 ",
              {
          ...
          >
            <PaginationLink
              className={cn(
                "hover:text-secondary-dark hover:bg-secondary-light text-[#414651]   w-20 text-[12px] font-semibold",
          ...
          >
            <PaginationLink
              ...
              className={cn(
                "hover:text-secondary-dark hover:bg-secondary-light text-[#414651] text-[12px] w-[60px]  font-semibold",
                currentPage === totalPages &&
  ...
  return (
    <div className='my-7 w-full bg-white  border-[1px] border-[#E9EAEB] shadow-[rgba(10,13,18,0.1)] !rounded-[12px]'>
      <div className=' flex justify-between lg:items-center items-end h-[81px] lg:flex-row px-[24px] flex-col gap-5 flex-wrap'>
              ...
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th
                    ...
                    className={cn(
                      "bg-[rgba(250,250,250,1)] h-[44px] text-start px-6 font-medium text-[12px] text-[#667085] border-b border-t  border-[rgba(233,234,235,1)] relative group",
                    )}
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <td
                      key={cell.id}
                      className={cn(
                        "h-[72px] px-6 border-b font-normal leading-[20px]  text-[#535862] space-y-[14px] border-[rgba(233,234,235,1)] text-[14px]",
                      )}
                    >
                      {flexRender(
      ...
      {!disablePagination && (
        <div className='flex justify-between px-[16px] py-[12px] !h-[68px]  '>
          <div className='justify-start  items-center gap-2 flex'>
            ...
            <CustomSelect
              className='w-[48px] !h-[30px] p-[6px] !text-[12px] text-[#4D4D4D]'
              options={["5", "10", "25", "50"]}
